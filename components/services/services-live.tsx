...
const SERVICES = [
  {
    ...
    desc: "Admin panels, CRM systems and full business platforms. Lots of data, made clear — screens your team understands without a manual.",
    chips: ["CRM / ADMIN PANELS", "BOOKING & ORDERS", "LIVE DATA", "CLEAN UI"],
    label: "dashboard.tsx",
  },
  {
    no: "/02",
    title: "Speed & Performance",
    desc: "A slow site loses customers. I make pages open in about a second — on any phone, even on weak internet.",
    chips: ["OPENS IN ~1s", "GOOGLE SCORE 98/100", "ANY DEVICE", "WEAK 3G? STILL FAST"],
    label: "performance.audit",
  },
  {
    no: "/03",
    title: "Security & Reliability",
    desc: "Safe login, protected payments and defence against common attacks. Your users' data stays theirs.",
    chips: ["SAFE LOGIN", "DATA PROTECTION", "ATTACK-RESISTANT", "REGULAR CHECKS"],
    label: "security.scan",
  },
  {
    no: "/04",
    title: "Motion & Interaction",
    desc: "The animations you are seeing on this very page. Motion that guides the eye and makes a product feel alive — without slowing it down.",
    chips: ["LIKE THIS PAGE", "SMOOTH ANIMATIONS", "SMALL DELIGHTFUL DETAILS"],
    label: "motion.config",
  },
];
